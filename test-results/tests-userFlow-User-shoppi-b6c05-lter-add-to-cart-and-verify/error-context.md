...
- Name: User shopping flow >> Filter, add to cart and verify
- Location: C:\Users\user\Documents\GitHub\final-project\tests\userFlow.spec.ts:16:7
...
Call log:
  - waiting for locator('[data-test="product_sort_container"]')
    ...
    at HomePage.sortProducts (C:\Users\user\Documents\GitHub\final-project\pages\home\home.ts:6:21)
    at C:\Users\user\Documents\GitHub\final-project\tests\userFlow.spec.ts:22:20
```
...
```ts
   ...
   2 | import { homeLocators } from './homeLocator';
   3 |
   4 | export class HomePage extends BasePage {
   5 |   async sortProducts(value: string) {
>  6 |     await this.page.selectOption(homeLocators.productSort, { value });
     |                     ^ Error: page.selectOption: Test timeout of 30000ms exceeded.
   7 |   }
   8 |
   9 |   async addBackpackToCart() {
  10 |     await this.click(homeLocators.addToCartButton);
  11 |   }
  12 |
  13 |   async goToCart() {
  14 |     await this.click(homeLocators.cartIcon);
  15 |   }
  16 | }
  17 |
```